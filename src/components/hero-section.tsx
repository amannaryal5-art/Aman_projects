      ...
      <div className="relative grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        ...
        >
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-text md:text-6xl md:leading-[1.05]">
            Aman Naryal builds reliable backend systems and polished full stack products.
          </h1>
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-400 md:text-lg">
            I build intelligent, API-driven full stack applications using Node.js, TypeScript &
            PostgreSQL from backend architecture to seamless frontend integration.
          </p>
